...
insert into users (id, username, full_name, email, phone, web_site, bio, birth_date, user_gender, public_profile, publicdm, taggable)values (4, 'mark', "Mark Zukenber", "mark@mailinator.com", "069/689-55-47", "www.facebook.com", "Founder of Facebook", "1984-05-14", 0, true, true, true);
