...
--POSTS
    ...
    insert into post_tags (post_id, tags_id) values (8, 1);
    insert into post_tags (post_id, tags_id) values (8, 2);
    insert into post_tags (post_id, tags_id) values (8, 3);
    insert into post (description, file_name, username, location_id, is_image) values ("ko je gledao got?", "got2.jpg", "masa", 1, true);
    insert into post_tags (post_id, tags_id) values (9, 7);
    insert into post_tags (post_id, tags_id) values (9, 10);
    insert into post_tags (post_id, tags_id) values (9, 11);
    insert into post (description, file_name, username, location_id, is_image) values ("ja biram tebeee", "pokemon5.jpg", "masa", 4, true);
    insert into post_tags (post_id, tags_id) values (10, 6);
    insert into post_tags (post_id, tags_id) values (10, 4);
